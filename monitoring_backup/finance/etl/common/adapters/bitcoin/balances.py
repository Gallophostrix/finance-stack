...
from .api import ASSET_CODE, addr_payload
from .utils import (
    COINGECKO_ID,
    DECIMALS,
    DEFAULT_BASE,
...
def fetch_balances(
    cfg_chain: dict, *, logger=None, http: Optional[HttpClient] = None
    ...
    Returns:
      rows = [
        {"account_type":"address","external_identifier":"<addr>","asset":"BTC","amount_native":Decimal},
        ...
      ]
